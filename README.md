...
Similar to snake game. Multiple gameplays allowed. Red obstacles and borders to be avoided. Highscore is recorded after each gameplay. Arrow keys are used to move alien. Q key to quit game. N key for new game.
